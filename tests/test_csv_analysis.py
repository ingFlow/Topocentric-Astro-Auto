...
REAL_PIPELINE_MAPPING = {
    "SECONDARY_DIRECT": (ptf.TechniqueType.SECONDARY_DIRECT, significators_rules.AspectType.ANGLE_HOUSE_PRIMARY, False),
    "PSSR": (ptf.TechniqueType.PSSR, significators_rules.AspectType.MOON_ANGLE_HOUSE_PRIMARY, True),
    "TRANSIT": (ptf.TechniqueType.TRANSIT, significators_rules.AspectType.ANGLE_PRIMARY, False),
}
