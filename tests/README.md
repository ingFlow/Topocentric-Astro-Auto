...
```bash
export TOPO_ASTRO_SOURCE_ROOT=/path/to/the/flat/source/tree   # defaults to /home/claude/repo_extracted
pip install pytest pyswisseph julian timezonefinder pytz pandas openpyxl requests
