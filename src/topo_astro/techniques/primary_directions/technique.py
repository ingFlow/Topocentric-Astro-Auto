...
The significator/scoring engine that used to live in this file (the
PRIMARY_RULES/SECONDARY_RULES/PLANETARY_COMBO tables and the
is_acceptable_*/count_*_acceptable_aspects functions) moves to
significators/ in a later phase, since it's reused by five of the seven
techniques, not specific to Primary Directions.
