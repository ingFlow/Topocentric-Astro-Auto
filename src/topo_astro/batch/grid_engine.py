"""
batch/grid_engine.py - the offline/batch rectification engine ("Mode 2"
per the Developer Manual): candidate-time-list generation
...
Recent changes:
    - De-duplication phase: TechniqueType is now an alias for
      core.constants.aTechniqueType rather than a separately-defined,
      incomplete local enum - see the comment at its definition below for why.
