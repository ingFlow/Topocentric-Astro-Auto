"""
batch/entrypoints.py - the top-level batch/rectification orchestration
functions: pd_rect_grid_score_create, rect_ver_data_create,
other_techniques_from_times, count_pssr_moon_write. These are the
