...
PRIMARY_RULES = {
    ...
    EventType.SUCCESS: (('H10','H1','H3'), (Planet.SUN, Planet.JUP, Planet.MON, Planet.MER, Planet.URA, Planet.VEN), GoodBadFlag.GOOD),
    EventType.FAILURE: (('H10','H1', 'H3'), (Planet.SAT, Planet.NEP, Planet.NNO, Planet.MAR, Planet.SUN), GoodBadFlag.BAD),
    ...
    EventType.GRADUATION: (('H10','H1','H3'), (Planet.MER, Planet.MON, Planet.JUP, Planet.SUN, Planet.URA, Planet.VEN), GoodBadFlag.GOOD),
    ...
    EventType.MARRIAGE_FOR_MALE:(('H10','H7','H5'),(Planet.VEN,Planet.MON,Planet.NNO,Planet.JUP), GoodBadFlag.GOOD),
    EventType.MARRIAGE_FOR_FEMALE:(('H10','H7','H5'),(Planet.SUN,Planet.JUP,Planet.MAR,Planet.NNO), GoodBadFlag.GOOD),
    ...
    EventType.DEATH_WIFE:(('H4','H7','H8'),(Planet.MON,Planet.VEN,Planet.SAT,Planet.NEP,Planet.PLU,Planet.NNO,Planet.MAR), GoodBadFlag.BAD),
    EventType.DEATH_HUSBAND:(('H4','H7','H8'),(Planet.SAT,Planet.SUN,Planet.NEP,Planet.PLU,Planet.NNO,Planet.MAR), GoodBadFlag.BAD),
...
SECONDARY_RULES = {
    ...
    EventType.MARRIAGE_FOR_FEMALE:((''), (Planet.MER,Planet.URA,Planet.VEN,Planet.MON)),
...
PLANETARY_COMBO = {
    ...
    EventType.DEATH_HUSBAND: ((Planet.SUN,Planet.MAR),(Planet.SUN,Planet.SAT),(Planet.SUN,Planet.URA),(Planet.SUN,Planet.NEP),(Planet.SUN,Planet.PLU),(Planet.MER,Planet.MAR),(Planet.MER,Planet.SAT),(Planet.MER,Planet.URA),(Planet.MER,Planet.PLU),(Planet.MER,Planet.NNO),(Planet.MAR,Planet.SAT),(Planet.MAR,Planet.URA),(Planet.MAR,Planet.NEP),(Planet.MAR,Planet.PLU),(Planet.MAR,Planet.NNO),(Planet.JUP,Planet.SAT),(Planet.JUP,Planet.NEP),(Planet.JUP,Planet.PLU),(Planet.JUP,Planet.NNO),(Planet.SAT,Planet.URA),(Planet.SAT,Planet.NEP),(Planet.SAT,Planet.PLU),(Planet.SAT,Planet.NNO),(Planet.URA,Planet.NEP),(Planet.URA,Planet.PLU),(Planet.URA,Planet.NNO),(Planet.NEP,Planet.PLU),(Planet.NEP,Planet.NNO),(Planet.PLU,Planet.NNO)),
    EventType.DEATH_WIFE: ((Planet.MON,Planet.MAR),(Planet.MON,Planet.SAT),(Planet.MON,Planet.URA),(Planet.MON,Planet.NEP),(Planet.MON,Planet.PLU),(Planet.MON,Planet.NNO),(Planet.MER,Planet.MAR),(Planet.MER,Planet.SAT),(Planet.MER,Planet.URA),(Planet.MER,Planet.PLU),(Planet.MER,Planet.NNO),(Planet.VEN,Planet.SAT),(Planet.VEN,Planet.URA),(Planet.VEN,Planet.NEP),(Planet.VEN,Planet.PLU),(Planet.VEN,Planet.NNO),(Planet.MAR,Planet.SAT),(Planet.MAR,Planet.URA),(Planet.MAR,Planet.NEP),(Planet.MAR,Planet.PLU),(Planet.MAR,Planet.NNO),(Planet.JUP,Planet.SAT),(Planet.JUP,Planet.NEP),(Planet.JUP,Planet.PLU),(Planet.JUP,Planet.NNO),(Planet.SAT,Planet.URA),(Planet.SAT,Planet.NEP),(Planet.SAT,Planet.PLU),(Planet.SAT,Planet.NNO),(Planet.URA,Planet.NEP),(Planet.URA,Planet.PLU),(Planet.URA,Planet.NNO),(Planet.NEP,Planet.PLU),(Planet.NEP,Planet.NNO),(Planet.PLU,Planet.NNO)),
    ...
    EventType.MOBILIZATION: (EventType.FAILURE),
    EventType.DEMOBILIZATION_RELEASE: (EventType.SUCCESS),
    ...
    EventType.INTRIGUE: (EventType.FAILURE),
...
def appropriate_base(good_bad_flag, aspect, p1, p2, event_id):
    ...
    if ((event_id == EventType.BIRTH_GRANDDAUGHTER) and flag_angle_pof and (p1 in [Planet.MER,])):
        return True
    if ((event_id == EventType.MARRIAGE_FOR_MALE) and flag_angle_pof and (p1 in [Planet.MER])):
        return True
    if ((event_id == EventType.MARRIAGE_FOR_FEMALE) and flag_angle_pof and (p1 in [Planet.MER, Planet.MON, Planet.VEN])):
        return True
    ...
    if ((event_id == EventType.DEATH_DAUGHTER) and flag_angle_pof and (p1 in [Planet.URA, Planet.MAR])):
        return True
    if ((event_id == EventType.DEATH_WIFE) and flag_angle_pof and (p1 in [Planet.URA])):
        return True
    if ((event_id == EventType.DEATH_HUSBAND) and flag_angle_pof and (p1 in [Planet.URA])):
        return True
